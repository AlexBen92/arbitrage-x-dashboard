...
const backtestsData: TokenBacktest[] = [
  {
    ...
    metrics: {
      ...
      kurtosis: 2.8,
      kellyCriterion: 12.5,
      walkForwardInSample: 21.5,
      walkForwardOutOfSample: 14.8,
      walkForwardConsistency: 78.5,
      inSampleReturn: 21.5,
      outOfSampleReturn: 14.8,
      overfittingRatio: 1.45,
  ...
  },
  {
    ...
    metrics: {
      ...
      kurtosis: 3.1,
      kellyCriterion: 11.2,
      walkForwardInSample: 19.2,
      walkForwardOutOfSample: 13.8,
      walkForwardConsistency: 82.1,
      inSampleReturn: 19.2,
      outOfSampleReturn: 13.8,
      overfittingRatio: 1.39,
  ...
  },
  {
    ...
    metrics: {
      ...
      kurtosis: 4.2,
      kellyCriterion: 18.7,
      walkForwardInSample: 18.5,
      walkForwardOutOfSample: 16.8,
      walkForwardConsistency: 91.2,
      inSampleReturn: 18.5,
      outOfSampleReturn: 16.8,
      overfittingRatio: 1.10,
  ...
  },
  {
    ...
    metrics: {
      ...
      kurtosis: 3.6,
      kellyCriterion: 16.3,
      walkForwardInSample: 23.8,
      walkForwardOutOfSample: 19.2,
      walkForwardConsistency: 85.7,
      inSampleReturn: 23.8,
      outOfSampleReturn: 19.2,
      overfittingRatio: 1.24,
  ...
  },
  {
    ...
    metrics: {
      ...
      kurtosis: 4.8,
      kellyCriterion: 14.8,
      walkForwardInSample: 28.5,
      walkForwardOutOfSample: 22.8,
      walkForwardConsistency: 79.8,
      inSampleReturn: 28.5,
      outOfSampleReturn: 22.8,
      overfittingRatio: 1.25,
  ...
  },
  {
    ...
    metrics: {
      ...
      kurtosis: 5.2,
      kellyCriterion: 8.9,
      walkForwardInSample: 42.8,
      walkForwardOutOfSample: 32.5,
      walkForwardConsistency: 71.3,
      inSampleReturn: 42.8,
      outOfSampleReturn: 32.5,
      overfittingRatio: 1.32,
