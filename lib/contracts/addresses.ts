...
export const STRATEGIES = [
  ...
  },
  {
    ...
    maxDD: 0.0,
    badge: "LIVE" as const,
    description: "Threshold 0.05% sur MATIC pour un taux de hit plus élevé",
  ...
  },
  {
    ...
    maxDD: 3.8,
    badge: "LIVE" as const,
    description: "Spread 0.2% bid/ask + skew inventaire hedgé perp LINK",
  ...
  },
  {
    ...
    maxDD: 2.6,
    badge: "LIVE" as const,
    description: "skewFactor 2.0 pour rebalancement inventaire plus rapide",
  ...
  },
  {
    ...
    maxDD: 3.0,
    badge: "BETA" as const,
    description: "skewFactor 0.5 — tolère plus d'inventaire (SOL revient vite)",
  ...
  },
  {
    ...
    maxDD: 6.7,
    badge: "BETA" as const,
    description: "Alpha = R_ETH − 1.4 × R_BTC, hedge ratio 80%",
